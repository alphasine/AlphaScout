...
const defaultFavoritePrompts = [
  ...
  },
  {
    ...
    content: 'Follow us at https://x.com/alphasine to stay updated on the latest AlphaScout news and features!',
  },
  {
    title: '🌟 Star us on GitHub!',
    content:
      "Open the AlphaScout repository at https://github.com/alphasine/alphascout and check if you've already starred it. If not, please support us by giving us a star!",
  },
];
